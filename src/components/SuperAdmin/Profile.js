...
const Profile = () => {
  ...
  const [profileImage, setProfileImage] = useState('/images/defaultuser.jpg');
      ...
      if (id) {
        try {
          ...
          if (userDocSnapshot.exists()) {
            ...
            setProfileImage(userData.profileImage || '/images/defaultuser.jpg');
      ...
      <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
        ...
        <div class="sm:col-span-9">
          <div class="flex items-center gap-5">
            <img class="inline-block size-20 rounded-full ring-2 ring-white dark:ring-neutral-900" src={profileImage} alt="User Image"/>
